...
if( file_exists( \Wpcafe::plugin_dir() . 'core/modules/guten-block/inc/blocks/location.php' )){
	include_once \Wpcafe::plugin_dir() . 'core/modules/guten-block/inc/blocks/location.php';
}
